        ...
        synchronized (list) {
            ...
            while (!stop) {
                ...
                if (listsize < limit) {
                    ...
                    System.out.println(
                            "P: Limit reached. Setting lock to notify others waiting, and going to sleep waiting...");
                    list.notify();
                    list.wait();
                }
                Thread.sleep(200);
        ...
        synchronized (this.list) {
            ...
            while (!this.stop) {
                if (list.size() > 0) {
                    ...
                    System.out.println(
                            "C: The list is empty. Setting lock to notify others waiting, and going to sleep waiting...");
                    list.notify();
                    list.wait();
                }
                Thread.sleep(200);
...
public class ProducerConsumerApp {
    ...
    public static void main(String[] args) {
        ...
        try {
            System.out.println("main: giving them 10 seconds to run.");
            Thread.sleep(10000);
            System.out.println("main: 10 seconds finished, commanding them to stop.");
            pc.stop();
